...
begin
 ...
 begin
      ADOQuery2.SQL.Text := 'SELECT * FROM ' + adatbázisNév + '.production.Tételek WHERE partner_id = :partnerID';
      ...
      //
        ...
        while not ADOQuery2.Eof do
            begin
              //assign termék
              ADOQuery13.SQL.Text := 'SELECT áfa_kulcs FROM ' + adatbázisNév +  '.production.Termékek WHERE termék_id = :termékID';
 ...
 begin
    ADOQuery14.SQL.Text := 'SELECT netto_forgamli_érték FROM ' + adatbázisNév + '.production.Tételek';
